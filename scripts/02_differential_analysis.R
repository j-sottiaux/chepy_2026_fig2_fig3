...
cytoplasm_extended_da <- compute_extended_diff_analysis(df = cytoplasm_matrix, matrix_type = "cytoplasm")
nucleus_extended_da <- compute_extended_diff_analysis(df = nucleus_matrix, matrix_type = "nucleus")

### 2/ Data visualization -----
# a/ Volcano plots ----
# Import limma toptables for plotting
...
# b/ "Differential Analysis Explorer" visualization ----
# Import limma extended toptables for plotting
